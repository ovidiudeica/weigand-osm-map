...
// RC8/v1.4 transport adapter: reconstructs deterministic gzip payloads from UTF-8 Base64 chunks.
(() => {
  const nativeFetch = window.fetch.bind(window);
  const encoded = {
    "data/weigand-osm-v1.4.geojson.gz": [
      "data/transport-v14/v14-full-01.b64",
      "data/transport-v14/v14-full-02.b64",
      "data/transport-v14/v14-full-03.b64",
    ...
    "data/weigand-osm-v1.4-semantic-236.csv.gz": [
      "data/transport-v14/v14-semantic-01.b64",
      "data/transport-v14/v14-semantic-02.b64",
      "data/transport-v14/v14-semantic-03.b64"
    ]
  };
  const cache = new Map();

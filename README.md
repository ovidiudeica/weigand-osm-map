...
Paleta markerelor OSM Standard este: **Români/Dacoromâni — albastru `#2F95ED`; Aromâni — roșu `#F25752`; Români + Aromâni — violet `#A66BE8`; Toponime — portocaliu `#FF9F1C`**; contur ivory `#FFF8E7`. Harta publică utilizează numai basemap-ul OpenStreetMap Standard / OSM Carto, cu atribuire vizibilă.
